...
\u05E2\u05D3\u05DB\u05D5\u05DF \u05D0\u05D7\u05E8\u05D5\u05DF: ${toolResult.last_comment || "\u05D4\u05E7\u05E8\u05D9\u05D0\u05D4 \u05D1\u05D8\u05D9\u05E4\u05D5\u05DC \u05E9\u05D5\u05D8\u05E3"}.`;
                ...
                if (textReply && textReply.length > 0) {
                  const isResolutionIndicated = /תודה|עזר|הסתדר|עובד|נפתר|הצליח|נפתרה|מעולה|מצוין|אחלה|סבבה|פתרת|עזרת|יופי/i.test(question) || /שמחתי לעזור|נפתרה בהצלחה|התקלה נפתרה|הטיפול הושלם|הפתרון הושלם|שמח שהסתדר|שמח שזה עובד|קריאה נסגרה/i.test(textReply);
