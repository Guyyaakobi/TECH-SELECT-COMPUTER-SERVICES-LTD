...
export const AccessibilityModal: React.FC<AccessibilityModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div
        dir={isHe ? 'rtl' : 'ltr'}
        className={`relative w-full max-w-md border rounded-2xl p-6 space-y-5 transition-all duration-200 backdrop-blur-2xl ${
          isDark 
            ? 'bg-[#0a1122]/80 border-white/[0.14] text-slate-100 shadow-[0_16px_50px_0_rgba(0,0,0,0.6),inset_0_1px_0_0_rgba(255,255,255,0.14)]' 
            : 'bg-white/85 border-slate-200/90 text-slate-900 shadow-[0_16px_40px_0_rgba(15,23,42,0.1),inset_0_1px_0_0_rgba(255,255,255,0.95)]'
