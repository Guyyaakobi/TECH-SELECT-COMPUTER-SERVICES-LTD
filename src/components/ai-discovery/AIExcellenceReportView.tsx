  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 transition-all print:p-0 print:max-w-none">
      ...
      <div className={`mb-6 p-4 rounded-xl border text-xs flex flex-col md:flex-row md:items-center justify-between gap-3 print:hidden backdrop-blur-xl ${
        isDark 
          ? 'bg-[#0a1122]/65 border-white/[0.12] text-slate-300 shadow-[0_8px_30px_0_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.1)]' 
      ...
      {/* ========================================================================= */}
      <div className={`p-8 sm:p-12 rounded-2xl border transition-all print:border-none print:shadow-none print:p-0 print:bg-white print:text-black backdrop-blur-2xl ${
        isDark 
          ? 'bg-[#0a1122]/80 border-white/[0.14] text-slate-200 shadow-[0_25px_80px_0_rgba(0,0,0,0.6),inset_0_1px_0_0_rgba(255,255,255,0.14)]' 
          : 'bg-white/85 border-slate-200/90 text-slate-900 shadow-[0_25px_70px_0_rgba(15,23,42,0.08),inset_0_1px_0_0_rgba(255,255,255,0.95)]'
      }`}>
        ...
        <div className="pb-8 border-b border-slate-200 dark:border-slate-800">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
            ...
            <div className="bg-white/[0.04] dark:bg-[#0a1122]/55 p-4 rounded-xl border border-white/[0.08] dark:border-white/10 text-xs text-slate-600 dark:text-slate-300 font-mono space-y-1.5 shrink-0 min-w-[260px] backdrop-blur-md">
        ...
        <section className="my-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
            <div className={`p-4 rounded-xl border backdrop-blur-md transition-all ${
              isDark 
                ? 'bg-white/[0.04] border-white/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)]' 
                : 'bg-white/70 border-slate-200/80 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.95)]'
            }`}>
          ...
          <div className={`p-6 rounded-xl border backdrop-blur-md ${
            isDark 
              ? 'bg-white/[0.03] border-white/10 text-slate-200 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)]' 
              : 'bg-white/70 border-slate-200/80 text-slate-900 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.95)]'
          }`}>
        ...
        <section className="my-8 pt-6 border-t border-slate-200 dark:border-slate-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
            <div className={`p-5 rounded-xl border backdrop-blur-md transition-all ${
              isDark 
                ? 'bg-white/[0.04] border-white/10 text-slate-200 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)]' 
                : 'bg-white/70 border-slate-200/80 text-slate-900 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.95)]'
            }`}>
        ...
        <div className={`mt-10 p-6 sm:p-8 rounded-xl text-center space-y-4 print:hidden border backdrop-blur-xl ${
          isDark 
            ? 'bg-[#0a1122]/75 border-white/[0.14] text-white shadow-[0_16px_50px_0_rgba(0,0,0,0.6),inset_0_1px_0_0_rgba(255,255,255,0.12)]' 
            : 'bg-white/85 border-slate-200/90 text-slate-900 shadow-[0_16px_40px_0_rgba(15,23,42,0.08),inset_0_1px_0_0_rgba(255,255,255,0.95)]'
        }`}>
