...
// 21. CHECK POINT SOFTWARE - Official Check Point Logo (Icon + Wordmark from Check Point Official Assets)
export const CheckPointLogo: React.FC<LogoProps> = ({ className = "w-14 h-6" }) => (
  <svg viewBox="0 0 205 44" className={className} fill="none" aria-label="Check Point Software Technologies Logo">
    {/* CHECK POINT Wordmark & circle */}
    <g fill="currentColor" className="text-slate-900 dark:text-white">
      <path d="M46.7,29.9h0c0-4.3,3.2-7.8,7.7-7.8s4.4.9,5.8,2.3l-2.1,2.4c-1.1-1-2.3-1.7-3.8-1.7-2.5,0-4.3,2.1-4.3,4.6h0c0,2.6,1.7,4.7,4.3,4.7s2.7-.7,3.9-1.7l2.1,2.1c-1.5,1.6-3.2,2.7-6,2.7-4.3,0-7.5-3.4-7.5-7.7Z" />
      <path d="M62.9,22.4h3.2v5.9h6v-5.9h3.2v14.9h-3.2v-6h-6v6h-3.2v-14.9Z" />
      <path d="M79.2,22.4h11.1v2.9h-7.9v3h6.9v2.9h-6.9v3.1h8v2.9h-11.2v-14.9Z" />
      <path d="M92.7,29.9h0c0-4.3,3.2-7.8,7.7-7.8s4.4.9,5.8,2.3l-2.1,2.4c-1.1-1-2.3-1.7-3.8-1.7-2.5,0-4.3,2.1-4.3,4.6h0c0,2.6,1.7,4.7,4.3,4.7s2.7-.7,3.9-1.7l2.1,2.1c-1.5,1.6-3.2,2.7-6,2.7-4.3,0-7.5-3.4-7.5-7.7Z" />
      <path d="M108.8,22.4h3.2v6.5l6-6.5h3.9l-6,6.3,6.3,8.6h-3.9l-4.6-6.4-1.7,1.8v4.6h-3.2v-14.9h0Z" />
      <path d="M130.8,22.4h6c3.5,0,5.6,2.1,5.6,5.2h0c0,3.5-2.6,5.3-6,5.3h-2.5v4.5h-3.2v-14.9h0ZM136.6,29.9c1.6,0,2.6-1,2.6-2.3h0c0-1.5-1-2.3-2.6-2.3h-2.5v4.6h2.6,0Z" />
      <path d="M144.5,29.9h0c0-4.3,3.3-7.8,7.8-7.8s7.8,3.4,7.8,7.7h0c0,4.3-3.3,7.8-7.8,7.8s-7.8-3.4-7.8-7.7ZM156.8,29.9h0c0-2.6-1.8-4.7-4.5-4.7s-4.4,2.1-4.4,4.6h0c0,2.6,1.8,4.7,4.5,4.7s4.4-2.1,4.4-4.6Z" />
      <path d="M163.3,22.4h3.2v14.9h-3.2v-14.9Z" />
      <path d="M170.6,22.4h3l6.9,9.2v-9.2h3.2v14.9h-2.8l-7.1-9.5v9.5h-3.2v-14.9Z" />
      <path d="M191,25.4h-4.5v-3h12.2v3h-4.5v11.9h-3.2v-11.9h0Z" />
...
// 29. ACRONIS - Official Acronis Cyber Protection Wordmark & Cyber Blue Emblem #0078D7
export const AcronisLogo: React.FC<LogoProps> = ({ className = "w-14 h-6" }) => (
  <svg viewBox="90 45 800 170" className={className} fill="none" aria-label="Acronis Cyber Protection Logo">
    {/* Iconic Acronis 'A' in Cyber Blue #0078D7 */}
    <path
      fill="#0078D7"
      d="M172.5,50.7h25l65.7,157.4h-24.1l-11.3-28.7h-85.4l-11.6,28.7h-24.1L172.5,50.7z M219.9,159.7l-7.4-18.1h-55.1l-7.2,18.1H219.9z M205.3,123.1l-4.2-10.2c-6.7-16.7-12.5-30.6-16.2-41c-3.5,10.4-9.3,24.3-16,41l-4.2,10.2H205.3z"
    />
    {/* "cronis" letters in adaptive theme color */}
    <path
      fill="currentColor"
      className="text-slate-900 dark:text-white"
      d="M265.1,147c0-37.7,27.8-63.4,63.7-63.4c30.8,0,54.2,17.6,59.5,47.9h-23.8c-5.3-18.7-18.1-27.1-36.1-27.1c-25.2,0-39.6,18.5-39.6,42.6c0,25.2,15.3,42.6,39.8,42.6c17.8,0,31-9,36.1-25.2h23.8c-7.4,29.6-31,46.1-60.9,46.1C289.1,210.4,265.1,183.5,265.1,147z M406.2,85.9h21.3l0.9,15.5c7.6-10.9,19-17.8,33.3-17.8h2.1v25.7h-3.5c-24.3,0-31,13.9-31,35.6v63.2h-23.1V85.9z M467.6,147c0-37.5,28-63.4,64.1-63.4c37.5,0,64.1,27.3,64.1,63.4c0,36.6-27.1,63.4-64.1,63.4S467.6,183.5,467.6,147z M572.2,146.7c0-24.1-15.7-42.4-40.5-42.4c-25.2,0-40.3,18.5-40.3,42.4c0,25.5,16.9,42.8,40.5,42.8C555.8,189.5,572.2,171.3,572.2,146.7z M612.9,85.9h20.6l1.6,12.7c9.5-9.9,22.4-15,39.1-15c28.9,0,45.1,17.1,45.1,47.4v77.1h-23.1v-72.7c0-19.9-7.9-30.8-26.9-30.8c-20.6,0-33.3,13.2-33.3,33.1v70.4h-23.1V85.9z M744.6,85.9h22.9v122.2h-22.9V85.9z M791.4,170.3h22.5c2.3,14.8,14.1,21.3,31.5,21.3c14.4,0,25.2-5.6,25.2-16.9c0-7.9-3.7-11.1-9.5-13.2c-5.6-2.1-11.3-3-22.9-4.9c-12-1.8-20.4-3.7-27.6-7.2c-11.1-5.3-15.5-15.3-15.5-26.4c0-25.9,20.4-39.6,46.5-39.6c28.5,0,47.4,13.2,48.8,39.8h-22c-1.4-14.1-12.5-21.1-26.8-21.1c-15.3,0-24.3,7.6-24.3,18c0,6.7,3.2,10.2,9.3,12.5c6,2.3,17.1,3.5,26.6,4.9c9,1.4,17.4,3,25,7.2c10.2,5.5,15,16.2,15,27.1c0,11.6-4.4,21.8-12.7,28.5c-8.8,7.2-20.4,10-35.2,10C815.5,210.4,793.7,199.3,791.4,170.3z"
    />
  </svg>
);

// 30. ARCSERVE - Official Arcserve Wordmark (Directly from arcserve-logo vector)
export const ArcserveLogo: React.FC<LogoProps> = ({ className = "w-16 h-5" }) => (
  <svg viewBox="0 0 846 120" className={className} fill="none" aria-label="Arcserve Logo">
    <g transform="matrix(1.3333333,0,0,-1.3333333,0,120)">
      <g transform="scale(0.1)">
        {/* Letters: a, r, c, s, e, r, e in adaptive theme color */}
        <g fill="currentColor" className="text-slate-900 dark:text-white">
          <path d="m 424.559,138.984 c -160.774,0 -291.59,140.887 -291.59,314.079 0,174.062 130.816,315.667 291.59,315.667 160.843,0 291.652,-141.605 291.652,-315.667 0,-173.192 -130.809,-314.079 -291.652,-314.079 M 782.723,900 c -37.274,0 -66.512,-29.199 -66.512,-66.43 V 777.633 C 637.707,855.801 533.176,900 424.559,900 190.461,900 0,699.504 0,453.063 0,206.543 190.461,6.04688 424.559,6.04688 c 108.164,0 212.656,44.80472 291.652,123.96512 V 72.5195 c 0,-36.0273 30.449,-66.47262 66.512,-66.47262 36.015,0 66.465,30.44532 66.465,66.47262 V 833.57 c 0,37.231 -29.2,66.43 -66.465,66.43" />
        ...
        {/* Signature Arcserve 'v' chevron stroke in Arcserve Teal/Cyan #00BFA5 */}
        <g fill="#00BFA5">
