...
export const SecureAIDevPage: React.FC<SecureAIDevPageProps> = ({
  ...
  return (
    <div className={`font-sans transition-colors duration-300 selection:bg-cyan-500 selection:text-white relative overflow-hidden bg-transparent ${
      ...
      {/* 1. HERO SECTION - SECURE AI DEVELOPMENT (Padded to sit cleanly under navbar and breadcrumbs while background reaches y=0) */}
      <div className="pt-36 sm:pt-40 pb-12 relative z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-12">
          ...
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 max-w-4xl mx-auto">
              <div className={`p-4 rounded-2xl border transition-all text-right ${
                isDark ? 'bg-white/[0.02] border-white/[0.07]' : 'bg-white/80 border-slate-200/80 shadow-2xs'
              }`}>
              ...
              <div className={`p-4 rounded-2xl border transition-all text-right ${
                ...
                <div className="flex items-center gap-2 mb-1 text-cyan-500 dark:text-cyan-400">
              ...
              <div className={`p-4 rounded-2xl border transition-all text-right ${
                ...
                <div className="flex items-center gap-2 mb-1 text-indigo-500 dark:text-indigo-400">
          ...
          <div className="space-y-8 pt-6">
            ...
            <div className={`p-8 sm:p-10 rounded-3xl mt-8 border transition-all backdrop-blur-md ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-mono font-bold text-blue-600 dark:text-blue-400">TIER 1</span>
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-mono font-bold text-emerald-600 dark:text-emerald-400">TIER 2</span>
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-mono font-bold text-cyan-600 dark:text-cyan-400">TIER 3</span>
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-mono font-bold text-purple-600 dark:text-purple-400">TIER 4</span>
